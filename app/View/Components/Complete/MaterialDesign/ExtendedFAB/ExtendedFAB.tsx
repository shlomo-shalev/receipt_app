...
// Interfaces
import ExtendedFABInterface from 'app/View/Components/Complete/MaterialDesign/ExtendedFAB/ExtendedFABInterface';

// Complete components
import CommonButton from 'app/View/Components/Complete/MaterialDesign/CommonButton/CommonButton';

function ExtendedFAB ({ title, type = 'elevated' }: ExtendedFABInterface) {
